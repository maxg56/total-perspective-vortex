...
PLOT_FIGSIZE_CSP: Final[Tuple[int, int]] = (12, 5)
PLOT_FIGSIZE_LEARNING: Final[Tuple[int, int]] = (10, 6)
PLOT_FIGSIZE_METRICS: Final[Tuple[int, int]] = (10, 6)
PLOT_FIGSIZE_ROC: Final[Tuple[int, int]] = (8, 6)
